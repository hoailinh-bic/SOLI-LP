...
// Standalone entry popup that mirrors the "Cẩm nang miễn phí / Tải tài liệu" section.
// It is fully self-contained and does NOT touch the original download section:
...
export default function DownloadPopup() {
  ...
  return (
    // Overlay: dimmed + blurred. Intentionally NO onClick handler -> clicking outside does not close.
    <div
      aria-hidden="false"
      style={{
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 40px 90px -34px rgba(11,74,57,0.7), inset 0 1px 0 rgba(255,255,255,0.9)',
      ...
      >
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0d2b22" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M18 6L6 18M6 6l12 12" /></svg>
        </button>

        <div style={{ maxWidth: 560, paddingRight: 8 }}>
          ...
          {submitted ? (
            <div className="animate-fade-in" style={{ marginTop: 18, background: 'rgba(16,185,129,0.1)', border: '1px solid rgba(16,185,129,0.28)', borderRadius: 16, padding: 20, textAlign: 'center' }}>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginTop: 20, fontFamily: "'Zalando Sans'", fontWeight: 700, fontSize: 11.5, letterSpacing: '0.4px', color: '#0c6b52' }}>* Cung cấp SĐT &amp; Email để hệ thống mở khóa link tải:</div>
